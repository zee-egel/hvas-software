...
export function Truck({ className }: IconProps) {
  return (
    ...
    >
      <path
        d="M89.034 43.825L74.452 27.423a3.2 3.2 0 0 0-2.859-1.284H58.256v-.448c0-3.723-3.029-6.752-6.751-6.752H6.752C3.029 18.94 0 21.969 0 25.692v35.098c0 2.219 1.805 4.024 4.023 4.024h10.374c.827 3.573 4.029 6.247 7.85 6.247s7.023-2.674 7.85-6.247h25.193h2.967h10.701c.827 3.573 4.029 6.247 7.85 6.247s7.023-2.674 7.85-6.247h1.519c2.109 0 3.825-1.715 3.825-3.825V46.367c0-.937-.343-1.84-.966-2.542zM85.213 43.993H67.936a.61.61 0 0 1-.609-.61v-7.785c0-.336.273-.609.609-.609h9.272l8.005 9.004zM6.752 21.907h44.753c2.086 0 3.784 1.698 3.784 3.785v.448v22.322H2.967v-22.77c0-2.087 1.698-3.785 3.785-3.785zM22.246 68.093c-2.81 0-5.097-2.286-5.097-5.097s2.287-5.097 5.097-5.097 5.097 2.286 5.097 5.097-2.287 5.097-5.097 5.097zm7.972-6.247c-.561-3.902-3.917-6.913-7.972-6.913s-7.411 3.011-7.972 6.913H4.023a1.057 1.057 0 0 1-1.056-1.057v-9.361h52.322v10.417H30.218zm46.589 6.247c-2.811 0-5.097-2.286-5.097-5.097s2.286-5.097 5.097-5.097 5.097 2.286 5.097 5.097-2.286 5.097-5.097 5.097zm9.368-6.247h-1.397c-.561-3.902-3.917-6.913-7.972-6.913s-7.411 3.011-7.972 6.913H58.256v-32.74h13.337c.244 0 .478.105.641.288l2.335 2.627h-6.634c-1.972 0-3.576 1.604-3.576 3.576v7.785c0 1.972 1.604 3.577 3.576 3.577h19.097v14.029c0 .384-.384.768-.858.768z"
        fill="currentColor"
      />
    </svg>
  );
...
export function LifeBuoy({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <line x1="4.9" x2="9.17" y1="4.9" y2="9.17" />
      <line x1="14.83" x2="19.1" y1="14.83" y2="19.1" />
      <line x1="14.83" x2="19.1" y1="9.17" y2="4.9" />
      <line x1="14.83" x2="18.36" y1="9.17" y2="5.64" />
      <line x1="4.9" x2="9.17" y1="19.1" y2="14.83" />
    </svg>
  );
}
